...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, INVALID_EMAIL, VALID_ORDER,
                VALID_REMARK, VALID_ADDRESS, VALID_TAGS, VALID_COMPANY, VALID_JOB, VALID_STOCK_PLATFORM,
                VALID_NETWORTH, false);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_ORDER, VALID_REMARK, invalidTags, VALID_COMPANY, VALID_JOB, VALID_STOCK_PLATFORM, VALID_NETWORTH,
                false);
