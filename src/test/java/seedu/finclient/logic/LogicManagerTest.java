...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonFinClientStorage finClientStorage =
                new JsonFinClientStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        JsonFinClientStorage finClientStorage = new JsonFinClientStorage(prefPath) {
            @Override
            public void saveFinClient(ReadOnlyFinClient finClient, Path filePath)
                    throws IOException {
                throw e;
            }
        };
